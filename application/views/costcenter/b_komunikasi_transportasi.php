<main role="main" class="main-content">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<h2 class="mb-2 page-title">Komunikasi dan Transportasi</h2>
				<p class="card-text"></p>
				<div class="row my-4">
					<!-- Small table -->
					<div class="col-md-12">
							...
							<div class="card-body">
								<div class="toolbar row mb-3">
									<div class="col-md-12">
										<div class="row">
											<div class="col-auto">
												<a href="#" class="btn btn-primary ml-2 d-md-table" data-toggle="modal" data-target="#tambahKomtrans">
											...
											<div class="col-auto">
												<a class="nav-link dropdown-toggle text-secondary border" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<strong class="mt-2">
														Pilih Menu :
														Beban &ndash; Komunikasi dan Transportasi
													</strong>
												</a>
	...
	<div class="modal fade" id="tambahKomtrans" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="varyModalLabel">Komunikasi dan Transportasi</h5>
				</div>
				<!-- TAMBAH METHOD -->
				<form action="<?= base_url('costcenter/tambah_beban') ?>" method="post">
					<div class="modal-body">
						...
						<input type="hidden" name="preferensi" value="7" required>
						<input type="hidden" name="akun" value="2" required>
						<input type="hidden" name="kategori" value="8" required>
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="detailBeban<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Detail Komunikasi dan Transportasi</h5>
					</div>
					<!-- detail METHOD -->
					<div class="modal-body">
						<ul class="list-group">
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="ubahBeban<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Ubah Komunikasi dan Transportasi</h5>
					</div>
					<!-- ubah METHOD -->
