<main role="main" class="main-content">
							...
							<div class="card-body">
								<div class="toolbar row mb-3">
									<div class="col-md-12">
										<div class="row">
											<div class="col-auto">
												<a href="#" class="btn btn-primary ml-2 d-md-table" data-toggle="modal" data-target="#tambahLegalitas">
	...
	<div class="modal fade" id="tambahLegalitas" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="varyModalLabel">Legalitas</h5>
				</div>
				<!-- TAMBAH METHOD -->
				<form action="<?= base_url('costcenter/tambah_beban') ?>" method="post">
					<div class="modal-body">
						...
						<input type="hidden" name="preferensi" value="8" required>
						<input type="hidden" name="akun" value="2" required>
						<input type="hidden" name="kategori" value="9" required>
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="detailBeban<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Detail Legalitas</h5>
					</div>
					<!-- detail METHOD -->
					<div class="modal-body">
						<ul class="list-group">
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="ubahBeban<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Ubah Legalitas</h5>
					</div>
					<!-- ubah METHOD -->
