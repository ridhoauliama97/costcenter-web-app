<main role="main" class="main-content">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<h2 class="mb-2 page-title">Pendapatan Lainnya</h2>
				<p class="card-text"></p>
				<div class="row my-4">
					<!-- Small table -->
					<div class="col-md-12">
							...
							<div class="card-body">
								<div class="toolbar row mb-3">
									<div class="col-md-12">
										<div class="row">
											<div class="col-auto">
												<a href="#" class="btn btn-primary ml-2 d-md-table" data-toggle="modal" data-target="#tambahLainnya">
											...
											<tr>
												...
												<td>
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item text-primary" href="#" data-toggle="modal" data-target="#detailLainnya<?= $key['id_transaksi'] ?>"><span class="fe fe-clipboard fe-16"></span>
															Detail
														</a>
														<a class="dropdown-item text-warning" href="#" data-toggle="modal" data-target="#ubahLainnya<?= $key['id_transaksi'] ?>"><span class="fe fe-edit fe-16"></span>
															Ubah
														</a>
	...
	<div class="modal fade" id="tambahLainnya" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="varyModalLabel">Pendapatan Lainnya</h5>
				</div>
				<!-- TAMBAH METHOD -->
				<form action="<?= base_url('costcenter/tambah_pendapatan') ?>" method="post">
					<div class="modal-body">
						...
						<input type="hidden" name="preferensi" value="4" required>
						<input type="hidden" name="akun" value="1" required>
						<input type="hidden" name="kategori" value="4" required>
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="detailLainnya<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Detail Pendapatan Lainnya</h5>
					</div>
					<!-- detail METHOD -->
					<div class="modal-body">
						<ul class="list-group">
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="ubahLainnya<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Ubah Pendapatan Lainnya</h5>
					</div>
					<!-- ubah METHOD -->
					<form action="<?= base_url('costcenter/ubah_pendapatan') ?>" method="post">
						<div class="modal-body">
							...
							<div class="form-group">
								<label for="uraian" class="col-form-label">Tanggal </label>
