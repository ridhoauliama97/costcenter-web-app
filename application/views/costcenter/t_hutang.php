<main role="main" class="main-content">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<h2 class="mb-2 page-title">Hutang</h2>
				<p class="card-text"></p>
				<div class="row my-4">
					<!-- Small table -->
					<div class="col-md-12">
							...
							<div class="card-body">
								...
								<table class="table table-sm datatables" id="dataTable-1">
									...
									<tbody class="text-center">
										...
										?>
											<tr>
												<td><?= str_pad($key['id_transaksi'], 6, 0, STR_PAD_LEFT) ?></td>
												...
												<td>
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item text-primary" href="#" data-toggle="modal" data-target="#detailHutang<?= $key['id_transaksi'] ?>"><span class="fe fe-clipboard fe-16"></span>
															Detail
														</a>
														<a class="dropdown-item text-dark" href="<?= base_url('costcenter/tertunda/hutang?transaksi=' . $key['id_transaksi']) ?>"><span class="fe fe-file-text fe-16"></span>
															Buat transaksi pembayaran
														</a>
														<!-- <a class="dropdown-item text-danger" href="<?= base_url('costcenter/ubah_tertunda/') . $key['id_transaksi']; ?>" onclick="return confirm('Tandai sebagai LUNAS? Anda dapat mengubahnya kembali pada halaman akun Beban / Biaya > <?= $this->session->userdata('kat') ?>.');">
	...
	<?php foreach ($cc as $key) { ?>
		<div class="modal fade" id="detailHutang<?= $key['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="varyModalLabel">Detail Hutang</h5>
					</div>
					<!-- detail METHOD -->
