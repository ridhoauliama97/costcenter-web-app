<main role="main" class="main-content">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-12">
				<h2 class="mb-2 page-title">Detail Piutang <?= str_pad($id, 6, 0, STR_PAD_LEFT) ?></h2>
				<p class="card-text"></p>
				<div class="row my-4">
					<!-- Small table -->
					<div class="col-md-12">
	...
	<div class="modal fade" id="bayarTagihan" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<!-- TAMBAH METHOD -->
				<form action="<?= base_url('costcenter/bayar_tertunda') ?>" method="post">
					<div class="modal-body">
						...
						<input type="hidden" name="kategori" value="12" required>
