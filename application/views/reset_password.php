	...
	<div class="card-body py-0">
		<div class="wrapper vh-100">
			<div class="row align-items-center h-100">
				<form class="needs-validation col-lg-3 col-md-4 col-10 mx-auto text-center" action="<?= base_url('auth/cek_reset') ?>" method="post" novalidate>
					...
					<p class="text-secondary">Masukkan Username akun yang akan direset.</p>
